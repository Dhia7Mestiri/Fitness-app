...
class WeatherScreen extends StatefulWidget {
  ...
  @override
  State<WeatherScreen> createState() => __WeatherScreenState();
}
class __WeatherScreenState extends State<WeatherScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children :[
        ...
        weatherRow('Tempreature', result.tempreature.toStringAsFixed(2)),
